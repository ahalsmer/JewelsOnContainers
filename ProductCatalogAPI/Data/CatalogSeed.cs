...
namespace ProductCatalogAPI.Data
{
    public static class CatalogSeed
    {
        ...
        {
            // this line tells entity framework to migrate from C# to SQL thus creating your tables
            context.Database.Migrate();

            if (!context.CatalogTypes.Any()) 
            { 
                // if table is empty, call your method to populate table with dummy data
                context.CatalogTypes.AddRange(GetCatalogTypes());
                // save the changes that you've made to your table
                context.SaveChanges();
            }
        ...
        // create a method that returns a list of dummy data
        ...
        private static IEnumerable<CatalogItem> GetCatalogItems()
        {
            return new List<CatalogItem>
            {
                ...
                new CatalogItem{CatalogTypeId = 1, CatalogBrandId = 2, Description = "All round", Name = "Incredible", Price = 248.5M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/11"},
                new CatalogItem{CatalogTypeId = 2, CatalogBrandId = 1, Description = "Priceless", Name = "London Sky", Price = 412, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/12"},
                new CatalogItem{CatalogTypeId = 3, CatalogBrandId = 3, Description = "You are the star", Name = "Eloquent", Price = 123, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/13"},
